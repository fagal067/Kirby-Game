Public Class Level3
    ...
    Sub MoveTo(p As PictureBox, distx As Integer, disty As Integer)
        ...
        End If
        If p.Name = "Bullet" And Collision(p, "marx") Then
        ...
        End If
        If inv = 0 And p.Name = "PictureBox1" And Collision(p, "marx",) Then
            ...
            End If
        End If
        If inv = 0 And p.Name = "PictureBox1" And Collision(p, "Laser",) Then
            KirbyBar.Value = KirbyBar.Value - 20
            inv = 15
            Timer3.Enabled = True
            laser.Visible = False
    ...
    End Sub
    Sub LaserShoot()
        If marx.Location.Y > PictureBox1.Location.Y - 10 Or marx.Location.Y > PictureBox1.Location.Y + 10 Then
            marx.Location.X -marx.Location.X - 10 = laser.Location
            Timer4.Enabled = True
        End If
    End Sub
End Class